...
ForgotPasswordPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-forgot-password',template:/*ion-inline-start:"/Users/nikolainossulenko/Desktop/CloudApi/OnlineAcademy/src/pages/forgot-password/forgot-password.html"*/'<!--\n  Generated template for the ForgotpasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header >\n  \n    <ion-navbar color="primary">\n      <ion-title>Wachtwoord Vergeten</ion-title>\n    </ion-navbar>\n  \n  </ion-header>\n  \n  \n  <ion-content padding class="container">\n      <form #loginForm="ngForm" novalidate>\n  <ion-card>\n    <ion-card-content>\n      <img src="assets/img/avatar.png" alt="avatar" class="avatar">\n      <p>Vul het email adres in dat je gebruikt om in te loggen bij OnlineAcademy</p>\n      \n      <ion-label>Email</ion-label>\n      <ion-input \n      [(ngModel)]="recovery" \n      type="email"\n      name="email"\n      pattern="[a-z0-9!#$%&\'*+/=?^_`{\}~-]+(?:\.[a-z0-9!#$%&\'*+/=?^_`{\}~-]+)*@(?:[a-z0-9](?:[a-z0-9]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?"\n      #email="ngModel" \n      required></ion-input>\n      <div *ngIf="email.invalid && email.dirty"><span class="global__input-error">E-mail adres ongeldig.</span></div>\n      <button ion-button block (click)="forgotpassword(recovery)" [disabled]="loginForm.invalid">\n        \n      Herstel wachtwoord</button>\n    \n\n    </ion-card-content>\n  </ion-card>\n  <button ion-button block text-center (click)="navigateToPage(\'LoginPage\')">Naar login</button>\n</form>\n  </ion-content>\n  '/*ion-inline-end:"/Users/nikolainossulenko/Desktop/CloudApi/OnlineAcademy/src/pages/forgot-password/forgot-password.html"*/,
    }),
