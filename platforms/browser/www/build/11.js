...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home2__ = __webpack_require__(514);
...
Home2Page = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home2',template:/*ion-inline-start:"/Users/nikolainossulenko/Desktop/CloudApi/OnlineAcademy/src/pages/home2/home2.html"*/'<ion-header>\n    <ion-navbar color="primary">\n        <ion-title>\n            Mijn MiR Journal\n        </ion-title>\n        <ion-buttons end>\n            <button (click)="goToAdd()"ion-button>\n                <ion-icon name="add"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding class="container">\n    <ion-list *ngIf="Notes$ !== undefined">\n        <ion-item detail-push *ngFor="let note of Notes$ | async" navPush="EditNotePage" [navParams]="{note: note}">\n            {{note.title}}\n        </ion-item>\n    </ion-list>\n\n    <p *ngIf="Notes$ === undefined">Nog geen notities, voeg een notitie toe.</p>\n</ion-content>'/*ion-inline-end:"/Users/nikolainossulenko/Desktop/CloudApi/OnlineAcademy/src/pages/home2/home2.html"*/
    }),
